...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "f9e39ebf8fa0a4aaf9a8111d4c504b630d8ee3d0"
            ParseMutableClientConfiguration.clientKey = "13939de200f1cefbbc6bf3acc385ba67689aa5be"
            // Place your public DNS
            ParseMutableClientConfiguration.server = "http://ec2-54-229-104-119.eu-west-1.compute.amazonaws.com:80/parse0"
        })
